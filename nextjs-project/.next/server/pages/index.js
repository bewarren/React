...
async function getStaticProps() {
  /// fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://udemyCourse:udemyCourse@cluster0.k1rxm.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
  const db = client.db();
